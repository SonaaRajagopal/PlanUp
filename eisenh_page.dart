...
class _EisenhowerMatrixScreenState extends State<EisenhowerMatrixScreen> {
  ...
  final Color _yellowLightColor = Colors.yellow.withOpacity(0.3);
  final Color _blueLightColor = Colors.blue.withOpacity(0.3);
  final Color _greenLightColor = Colors.green.withOpacity(0.3);
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 40, 170, 44), fontSize: 25),
                              textAlign: TextAlign.center,
                            ),
                          ),
